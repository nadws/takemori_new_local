<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><input type="hidden" class="tl" id="total_id<?= $o->id_order ?>" value="<?= $o->qty * $o->harga ?>">
            </td>
        </tr>
        <?php endforeach ?>
    </tbody>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><button type="button" id="btn_bayar" class="btn btn-info btn-sm save_btn btn-confirm" disabled><i
